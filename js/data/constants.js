...
// Department options
// 2026-08-25 部門再編（航也決定）
//   モバイルセールス・ソリューション部   → セールス事業部
//   デジタルライフ・コンサルティング部   → 未来開発事業部（吸収）
//   クリエイティブ・エンターテイメント部 → 未来開発事業部
//   経営戦略室 はそのまま／飲食事業部 を新設（当面は割当ゼロ）
// 🔴 dept は「部門」。所属会社は company フィールドが持つ（混ぜないこと）
